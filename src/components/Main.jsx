    ...
    <div className='w-full h-[550px] text-white'>
      <div className='w-full h-full'>
        ...
        <div className='absolute top-[20%] py-4 px-4' >
          ...
          <div className='my-4'>
            <button className='border bg-gray-300 border-gray-300 text-black py-2 px-5' >Where to watch</button>
            <button className='border border-gray-300 text-white py-2 px-5 ml-4'>Rate</button>
         </div>

...
const Navbar = () => {
  return (
    <div className='flex items-center justify-between p-4 z-[100] w-full absolute'>
      ...
      <div>
        <button className='w-[173.57px] h-[38.30px] opacity-75 bg-stone-950 rounded-[4.88px] border border-stone-50 text-white transitionduration-300 hover:opacity-50 transition'>Sign in</button>
